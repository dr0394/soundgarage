    ...
    <section className="pt-20 min-h-screen bg-[#1a1a1a] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative pt-16 pb-20">
        <div className="flex flex-col lg:flex-row gap-12 items-center lg:items-start">
          {/* Headline Section - Order 1 on mobile, Order 1 on desktop */}
          <div className="space-y-8 relative z-10 w-full lg:flex-1 order-1 text-center lg:text-left">
          ...
          {/* Image - Order 2 on mobile, Order 2 on desktop (right side) */}
          <div className="relative animate-fade-in-up w-full lg:flex-1 order-2" style={{ animationDelay: '0.3s', opacity: 0 }}>
          ...
          {/* Description, Button & Reviews - Order 3 on mobile (only visible on mobile) */}
          <div className="lg:hidden space-y-8 relative z-10 w-full order-3 text-center">
            ...
            <div className="flex items-center space-x-4 group/item hover:scale-105 transition-all duration-300 cursor-pointer justify-center">
              <svg viewBox="0 0 24 24" className="w-10 h-10 animate-float">
                <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
                <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/>
